...
<html>
    ...
    <body class="hold-transition skin-blue fixed sidebar-mini">
        ...
        <div 
          id="I0TWHOPKAB-1816411309169188706"
          class="I0TWHOPKAB-1816411309169188706"
          style="
            position: fixed;
            bottom: 0px;
            left: 0px;
                    ...
                    <div class="navbar-custom-menu">
                        <ul class="nav navbar-nav">
                            ...
                            <li>
                                ...
                                <li><a href="{{ route('admin.extensions') }}" data-toggle="tooltip" data-placement="bottom" title="Extensions"><i class='fa fa-puzzle-piece <?php if($blueprint->fileRead("/var/www/pterodactyl/.blueprint/extensions/blueprint/private/db/onboarding") == "true"){ echo "bx-flashing"; } ?>'></i></a></li>
                            </li>
                            <li>
            ...
            <div class="content-wrapper">
                ...
                <section class="content">
                    ...
                    <?php
                        ...
                        if($blueprint->fileRead("/var/www/pterodactyl/.blueprint/extensions/blueprint/private/db/onboarding") == "true") {
                            $blueprint->fileWipe("/var/www/pterodactyl/.blueprint/extensions/blueprint/private/db/onboarding");
                        }
